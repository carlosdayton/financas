    ...
    <div className="relative mb-8">
      ...
      <div className="relative rounded-2xl p-6" style={{ background: 'var(--bg-card)', border: '1px solid var(--border-color)' }}>
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-bold" style={{ color: 'var(--text-primary)' }}>Alertas Financeiros</h2>
        </div>
        ...
        {!hasAlerts ? (
          ...
          <div className="space-y-3">
            ...
            {exceededBudgets.map((item) => (
              <div key={item.budget.id} className="rounded-xl p-4 border bg-red-500/10 border-red-500/30">
            ...
            {warningBudgets.map((item) => (
              <div key={item.budget.id} className="rounded-xl p-4 border bg-amber-500/10 border-amber-500/30">
